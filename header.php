...
<body style="background-color: #f5f5f5;">
	...
	<nav class="navbar navbar-default"    >
		<div class="container">
			...
			<div class="navbar-header" style="color: #997950">
				...
				<a class="navbar-brand" href="#"><b style="color: #391e10">COFFEE HAVEN</b></a>
			</div>

			<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1" >
				<ul class="nav navbar-nav navbar-right">
					<li><a href="index.php" style="color: #391e10">Home</a></li>
					<li><a href="produk.php" style="color: #391e10">Menu</a></li>
					<li><a href="about.php" style="color: #391e10">About</a></li>
					<li><a href="manual.php" style="color: #391e10">Help</a></li>
					<?php 
					if(isset($_SESSION['kd_cs'])){
					$kode_cs = $_SESSION['kd_cs'];
