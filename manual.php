...
<div class="container">
		<h2 style=" width: 100%; border-bottom: 4px solid #391e10"><b style="color: #391e10 ">Manual Aplikasi</b></h2>
	<div class="bs-acc">
		<div class="panel-group" id="accordion">
			<div class="panel panel-default">
				<a data-toggle="collapse" data-parent="#accordion" href="#collapseOne" style="color:#fff;">
				<div class="panel-heading" style="background-color: #391e10;">
					<h4 class="panel-title">
						Bagaimana Cara Berbelanja Coffee Haven ?
					</h4>
				</div>
				</a>
