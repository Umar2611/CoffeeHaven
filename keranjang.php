...
<div class="container" style="padding-bottom: 300px;">
	<h2 style=" width: 100%; border-bottom: 4px solid #391E10"><b>Keranjang</b></h2>
				...
				if($jml > 0){
					...
					<?php 
					 ...
					 ?>
						...
						<tr>
							<td colspan="7" style="text-align: right; font-weight: bold;"><a href="produk.php" class="btn btn-success">Lanjutkan Belanja</a> <a href="checkout.php?kode_cs=<?= $kode_cs; ?>" class="btn btn-primary">Checkout</a></td>
						</tr>
						<?php 
					}else{
						echo "
